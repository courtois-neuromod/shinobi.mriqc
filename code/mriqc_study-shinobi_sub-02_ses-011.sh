...
datalad containers-run -m 'mriqc_sub-02/ses-011' -n containers/bids-mriqc --input sourcedata/shinobi/sub-02/ses-011/fmap/ --input sourcedata/shinobi/sub-02/ses-011/func/ --output . -- -w workdir/ --participant-label 02 --session-id 011 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
