...
datalad containers-run -m 'mriqc_sub-02/ses-012' -n bids-mriqc --input sourcedata/shinobi/sub-02/ses-012/fmap/ --input sourcedata/shinobi/sub-02/ses-012/func/ --output . -- -w workdir/ --participant-label 02 --session-id 012 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
