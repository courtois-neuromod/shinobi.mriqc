...
#SBATCH --job-name=mriqc_study-shinobi_sub-06_ses-011.job
#SBATCH --output=./code/mriqc_study-shinobi_sub-06_ses-011.out
#SBATCH --error=./code/mriqc_study-shinobi_sub-06_ses-011.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-06/ses-011' -n bids-mriqc --input sourcedata/shinobi/sub-06/ses-011/fmap/ --input sourcedata/shinobi/sub-06/ses-011/func/ --output . -- -w workdir/ --participant-label 06 --session-id 011 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-datalad-get  --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
