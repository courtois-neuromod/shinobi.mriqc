...
datalad containers-run -m 'mriqc_sub-06/ses-008' -n bids-mriqc --input sourcedata/shinobi/sub-06/ses-008/fmap/ --input sourcedata/shinobi/sub-06/ses-008/func/ --output . -- -w workdir/ --participant-label 06 --session-id 008 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
