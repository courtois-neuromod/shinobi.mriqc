...
#SBATCH --job-name=mriqc_study-shinobi_sub-06_ses-013.job
#SBATCH --output=./code/mriqc_study-shinobi_sub-06_ses-013.out
#SBATCH --error=./code/mriqc_study-shinobi_sub-06_ses-013.err
#SBATCH --time=2:00:00
...
datalad containers-run -m 'mriqc_sub-06/ses-013' -n bids-mriqc --input sourcedata/shinobi/sub-06/ses-013/fmap/ --input sourcedata/shinobi/sub-06/ses-013/func/ --output . -- -w workdir/ --participant-label 06 --session-id 013 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-datalad-get  --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
