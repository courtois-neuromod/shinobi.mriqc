...
datalad containers-run -m 'mriqc_sub-04/ses-001' -n bids-mriqc --input sourcedata/shinobi/sub-04/ses-001/fmap/ --input sourcedata/shinobi/sub-04/ses-001/func/ --output . -- -w workdir/ --participant-label 04 --session-id 001 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/shinobi ./ participant 
mriqc_exitcode=$?
